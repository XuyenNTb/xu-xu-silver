...
namespace WebNhaHangOnline.Models
{
    public class SanPhamModel
    {
        ...
        internal string ThemSP(SanPham sanpham)
        {
            ...
            //var khoSP = new KhoSP();
            //khoSP.MaSP = sanpham.MaSP;
            //khoSP.TenSP = sanpham.TenSP;
            //khoSP.DateExport = DateTime.Today;
            //khoSP.DateImport = DateTime.Today;
            //khoSP.SL = sanpham.SoLuong;
            //db.KhoSPs.Add(khoSP);
